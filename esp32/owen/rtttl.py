SONGS = [
    ...
    'O4:d=4,o=4,b=100: c, p, c#, p, d, p, d#, p, e, p, f, p, f#, p, g, p, g#, p, a, p, a#, p, b, p',
    'O5:d=4,o=5,b=100: c, p, c#, p, d, p, d#, p, e, p, f, p, f#, p, g, p, g#, p, a, p, a#, p, b, p',
    'O6:d=4,o=6,b=100: c, p, c#, p, d, p, d#, p, e, p, f, p, f#, p, g, p, g#, p, a, p, a#, p, b, p',
    'O7:d=4,o=7,b=100: c, p, c#, p, d, p, d#, p, e, p, f, p, f#, p, g, p, g#, p, a, p, a#, p, b, p',
]

def find(song_name: str):
    for song in SONGS:
        s = song.split(':')[0]
        if s == song_name:
            return song
